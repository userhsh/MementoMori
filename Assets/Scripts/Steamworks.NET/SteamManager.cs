...
public class SteamManager : MonoBehaviour {
	...
	{
		get { //스팀매니저의 싱글톤 패턴을 두어 스팀 플랫폼에 연결을 계속 유지
			if (s_instance == null) 
			{   //s_instance가 비었다면 스팀매니저를 추가
	...
	protected virtual void Awake() {
		...
		try {
            ...
            //스팀에 등록된 APPID를 작성하여 앱 실행 시 스팀 플랫폼과 연동을 시작
            //만약 스팀에서 실행하지 않았다면 프로세스 종료 후 스팀에서 다시 실행
			if (SteamAPI.RestartAppIfNecessary(new AppId_t(3422740)))  
			{	
